...
These are anti viruses that are SAFE to run on your computer unlike my rogues from the other repository. These guys are strong enemies of my Malware-Database and **will do anything to defeat them.** If your in need to remove a virus, get these guys.

Most of these only run on Windows 10 or higher.

Unlike our naughty Malware-Database, these files are safe so no passwords...
...
Source: [Bureau of Industry & Security, more commonly known as BIS.](https://web.archive.org/web/20250201211035/https://www.bis.gov/press-release/commerce-department-prohibits-russian-kaspersky-software-us-customers)
